...
//Custom variable I made for pushing the product paragraph over. It's the size of the product thumbnail.
$custom_thumb_width = 300;
	...
	<?php if(wpsc_display_products()): ?>
		...
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			...
			<div class="default_product_display product_view_<?php echo wpsc_the_product_id(); ?> <?php echo wpsc_category_class(); ?> group">
				...
				<?php endif; ?>
					<div class="productcol" style="margin-left:<?php echo $custom_thumb_width + 20; ?>px;" >

						<h2 class="prodtitle entry-title">
							<?php if(get_option('hide_name_link') == 1) : ?>
								<?php echo wpsc_the_product_title(); ?>
							<?php else: ?>
								<p class="wpsc_product_title"><?php echo wpsc_the_product_title(); ?></p>
							<?php endif; ?>
						</h2>
